...
//
// The language is idiomatic JavaScript for the SpiderMonkey shell.
...
// This is a hack for the sake of PJS but it improves performance for the non-PJS case
...
function traceWithoutAntialias(hmin, hlim) {
	...
	for ( var w=0 ; w < width ; w++ ) {
	    ...
	    bits.set(h, w, raycolor(eye, ray, 0, SENTINEL, reflection_depth));
	}
    }
}
