...
function m_mod_global_global(stdlib, ffi, heap) {
    "use asm";
...
{
    assertEq(isAsmJSModule(m_mod_global_global), true);
    let { f, g, h, i, j, k } = m_mod_global_global(this, {}, buffer);
    assertEq(f(), (37 % 4)|0);
    assertEq(g(), (37 % -4)|0);
    assertEq(h(), (-37 % 4)|0);
    assertEq(i(), (-37 % -4)|0);
...
// Not yet implemented
/*
function m_mod_global_global_d(stdlib, ffi, heap) {
    "use asm";
...
{
    assertEq(isAsmJSModule(m_mod_global_global_d), true);
    let { f } = m_mod_global_global_d(this, {}, buffer);
    assertEq(f(), 35%3.5);
}
*/
