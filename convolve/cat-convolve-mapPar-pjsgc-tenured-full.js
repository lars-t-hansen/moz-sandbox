...
// and the volume of this test is such that that is a major factor: by
// and large, tenured collections will be required for many slices,
// and we should expect to see many fallbacks to sequential execution
// to deal with slices that cannot be completed within the memory
// budget.
//
// Compare this to cat-convolve-mapPar-pjsgc-tenured-overflow, which
// has a much smaller volume and which often avoids sequential
// execution.
//
